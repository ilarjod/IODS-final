...
Predicting depressive tendencies based on if a person likes action movies is not the most effective way maybe but the `Movies` variable has some effect on the `Depression`variable.
